...
(function content() {
    ...
    function FJCTPremoveAllScripts(dochtml) {
        debug(true, "FJCTPremoveAllScripts");
        ...
        Array.prototype.forEach.call(dochtml.querySelectorAll("script"), function (element) {
          //if (!element.src.endsWith("OpenLayers.js")) {
            element.parentElement.removeChild(element);
          //}
        });
    }
    ...
    function FJCTPmodifyRouteDescriptionElement(element, firstAscenter, routeDescription) {
        ...
        //  <a href="/klettern/poi/5295" class="" id="DONE">Langschläferin</a>
        //  <a href="/klettern/personal/hitliste/eintragen/5295">&nbsp; 7- &nbsp;&nbsp;&nbsp;&nbsp;</a>
        //  <span>(unbekannt vor 1995 | Rotpunkt 17.04.18)</span>
        //  <br>
        //  Über Platte und an kleinem Überhang vorbei zu Band. Dann über abdrängendes Wändchen z. UH. Etws eingezwängte Routenführung.
        //</li>
    ...
    function FJCTPmodifyRockEventsSection(html) {
        ...
        for (var child of allChilds) {
          ...
          if (child.textContent.startsWith("Für diesen Fels gibt es derzeit kein Rock-Event")) {
          ...
          if (child.textContent.startsWith("Für diese Route gibt es derzeit kein Rock-Event.")) {
            debug(false, "FJCTPmodifyRockEventsSection --> removing empty RockEvent section");
            rockEventSection.parentElement.removeChild(rockEventSection);
            return;
          }
    ...
    function FJCTPmodifyDocument(document) {
        ...
        //}
          ...
          debug(false, "FJCTPmodifyGebietPage getChildTreeAsNodeList.length: " + allChilds.length);
          for (var child of allChilds) {
        ...
        FJCTPremoveElement(dochtml, "div.advertising-poi");                    //Werbung für Pensionen, Gaststätten
